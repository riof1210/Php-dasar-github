...
<body>
    ...
    <hr>
    <table width="450">
        <FORM ACTION="tiket.php" METHOD="POST" name="input">
            <tr>
                <td>Nama Pemesan</td>
                <td> : </td>
            ...
            <tr>
                ...
                <td><select name="jenis">
                        <option name="studio1" value="Studio 1"> Studio1</option>
                        <option name="studio2" value="Studio 2"> Studio2</option>
                    </select>
                </td>
            </tr>
            <tr>
                <td>Jenis Kelas </td>
                <td> : </td>
                <td> <input type="radio" name="kelas" value="VIP"> VIP
            ...
            <tr>
                <td></td>
                <td></td>
                <td><input type="submit" name="Input" value="Tampil">
